...
// #local test for reference (use HTTP instead of HTTPS)
...
// curl -X POST "https://nicoleliu.mids255.com/project-predict" -H "Content-Type: application/json" -d '{"text": ["I love you!", "I hate you!", "I am a Kubernetes Cluster!"]}'
